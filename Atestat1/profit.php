...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span align = "center" class="w3-bar-item w3-left-side" >Calcul profit</span>
</div>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <!-- Header -->
<div style="position: relative; top: 310px; left:50px;">
<table border = "1">
<form action = "calculprofit.php" method = "POST">
<tr>
 <th>ID Valuta:</th></tr>
 <tr>
...
<input type="submit" value = "Trimite!"></td></tr>
</form>
</table>
