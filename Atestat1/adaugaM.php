...
<h1 style="color:green;">
 ...
 <span align = "center" class="w3-bar-item w3-left-side" color = "red">Moneda <?php
$link = mysqli_connect("localhost", "root", "");
mysqli_select_db($link,"schimbvalutar"); 
echo $_POST['denumire']; 
?> a fost adaugata cu succes!</span><h1>
...
$q = "INSERT 
      INTO valuta
      VALUES(".$i.",'".$_POST['denumire']."','".$_POST['sold']."','".$_POST['data']."','".$_POST['sold']."')";
mysqli_query($link,$q);


$q1 = "INSERT 
      INTO curs
      VALUES(".$k.",".$k.",'".$_POST['denumire']."','".$_POST['data']."','".$_POST['cursv']."','".$_POST['cursc']."')";
