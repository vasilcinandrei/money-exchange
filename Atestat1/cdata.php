...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span align = "center" class="w3-bar-item w3-left-side" >Cautare tranzactie dupa data</span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="sterge" class="w3-bar-item w3-button w3-padding"><i class="fa fa-close"style="font-size:24px"></i> Stergerea unei tranzactii</a>
...
<body>
  <div style="position: absolute; top: 35%; right:37%;">
 <form action = "script.php" method = "POST">
 <h1><font color ="green">Introduceti data: </h1><input type = "date" name = "Data">
