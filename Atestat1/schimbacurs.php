...
<h1 style="color:green;">
 ...
 <span align = "center" class="w3-bar-item w3-left-side" color = "red">Cursul a fost modificat cu succes!</span><h1>
...
{
$q1 = "UPDATE curs
SET  Data ='".$_POST['Data']."', Cumparare = '".$_POST['val']."'
...
{
$q2 = "UPDATE curs
SET  Data ='".$_POST['Data']."', Vanzare = '".$_POST['val']."'
WHERE '".$_POST['denumire']."' = Denumire";
