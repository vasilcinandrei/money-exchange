...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span align = "center" class="w3-bar-item w3-left-side" >Stergere tranzactie</span>
</div>
...
<!--<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 <!-- Header -->
<h1 style="color:red;">
 <div style="position: absolute; top: 350px; left:770px;"?
 <span align = "center" class="w3-bar-item w3-left-side" color = "red">Tranzactie eliminata cu succes!</span><h1>
...
$t = "SELECT Suma, Tip, id_valuta
      FROM tranzactie
	  WHERE '".$_POST['ID_T']."' = id_tranzactie";
$result = mysqli_query($link,$t);
$row = mysqli_fetch_array($result);
$tvanzare = "SELECT Vanzare
             FROM curs
			 WHERE '".$row['id_valuta']."' = Denumire";
$result1 = mysqli_query($link,$tvanzare);
$row1 = mysqli_fetch_array($result1);
if($row['Tip'] != "Cumparare")
{

	$pv = ($row['Suma'] * $row1['Vanzare']);
	$c = "UPDATE valuta
SET Sold_Final = (Sold_Final - ".$pv.")
WHERE id_valuta = 6";
mysqli_query($link,$c);
	
$c1 = "UPDATE valuta
SET Sold_Final = (Sold_Final + ".$row['Suma'].")
WHERE Denumire = '".$row['id_valuta']."'";
mysqli_query($link,$c1);
...
if($row['Tip'] == "Cumparare")
{
	...
	$pv1 = ($row['Suma'] * $row1['Vanzare']);
	$c2 = "UPDATE valuta
SET Sold_Final = (Sold_Final + ".$pv1.")
WHERE id_valuta = 6";
mysqli_query($link,$c2);
	
$c3 = "UPDATE valuta
SET Sold_Final = (Sold_Final - ".$row['Suma'].")
WHERE Denumire = '".$row['id_valuta']."'";
mysqli_query($link,$c3);
