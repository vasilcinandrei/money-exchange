...
<!--
   ...
   <td><input type = "textbox" name = "ID"></td> -->
    <th>Nume</th>
	<br><td><input type = "textbox" name ="NUME"></td>
    <th>CNP</th>
	<td><input type = "textbox" name= "CNP"></td>
	<th>Data:</th>
...
?>
   ...
   <th>Suma:</th>
   <td><input type = "textbox" name ="SUMA"></td>
</table>
...
{
$q = "SELECT '".$_POST['SUMA']."' * Cumparare AS prod1
     FROM curs
...
echo '<br>';
echo "Rezultat: ";
echo round($row['prod1'],2);
echo " RON";
}
if($_POST['TIP'] != "Cumparare")
{
$q1 = "SELECT '".$_POST['SUMA']."' / Vanzare AS prod2
     FROM curs
	 WHERE '".$_POST['ID_V']."' = Denumire";
